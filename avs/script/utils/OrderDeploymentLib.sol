...
library OrderDeploymentLib {
    ...
    function deployContracts(
...

        {
            ...
            result.orderServiceManager = UpgradeableProxyLib.setUpEmptyProxy(
                proxyAdmin
            );
    ...
    function deployAndUpgradeStakeRegistryImpl(
        ...
        bytes memory upgradeCall = abi.encodeCall(
            ...
            (deployment.orderServiceManager, 0, quorum)
        );
    ...
    function deployAndUpgradeServiceManagerImpl(
        ...
        bytes memory upgradeCall = abi.encodeCall(
            OrderServiceManager.initialize,
    ...
    function readDeploymentJson(
        ...
        require(
            vm.exists(fileName),
            "OrderDeployment: Deployment file does not exist"
        );

        string memory json = vm.readFile(fileName);

        DeploymentData memory data;
        data.orderServiceManager = json.readAddress(
            ".addresses.orderServiceManager"
        );
    ...
    function writeDeploymentJson(DeploymentData memory data) internal {
        writeDeploymentJson("deployments/order/", block.chainid, data);
    }
    ...
    function writeDeploymentJson(
        ...
        address proxyAdmin = address(
            UpgradeableProxyLib.getProxyAdmin(data.orderServiceManager)
        );
    ...
    function readDeploymentConfigValues(
        ...
        require(
            ...
            "OrderDeployment: Deployment Config file does not exist"
        );
        ...
        data.maxResponseIntervalBlocks = uint32(json.readUint(".config.maxResponseIntervalBlocks"));
        return data;
    }
    ...
    function _generateContractsJson(
        ...
        return
            string.concat(
                ...
                '","orderServiceManager":"',
                data.orderServiceManager.toHexString(),
                '","orderServiceManagerImpl":"',
                data.orderServiceManager.getImplementation().toHexString(),
                '","stakeRegistry":"',
