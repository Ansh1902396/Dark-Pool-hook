...
library AVSDeploymentLib {
    ...
    function deployContracts(
...

        {
            ...
            result.orderServiceManager = UpgradeableProxyLib.setUpEmptyProxy(proxyAdmin);
    ...
    function deployAndUpgradeStakeRegistryImpl(
        ...
        bytes memory upgradeCall = abi.encodeCall(
            ECDSAStakeRegistry.initialize, (deployment.orderServiceManager, 0, quorum)
        );
    ...
    function deployAndUpgradeServiceManagerImpl(
        ...
        bytes memory upgradeCall =
            abi.encodeCall(OrderServiceManager.initialize, (owner, rewardsInitiator));

        UpgradeableProxyLib.upgradeAndCall(
            orderServiceManager, orderServiceManagerImpl, upgradeCall
        );
    }
    ...
    function readDeploymentJson(
        ...
        data.orderServiceManager = json.readAddress(".addresses.orderServiceManager");
    ...
    function writeDeploymentJson(
        ...
        address proxyAdmin =
            address(UpgradeableProxyLib.getProxyAdmin(data.orderServiceManager));
